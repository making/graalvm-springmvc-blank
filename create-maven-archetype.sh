...
sed -i.bk "s|graalvm-springmvc-blank|projectName|g" pom.xml
sed -i.bk "s|github\.com/making/projectName|github.com/making/graalvm-springmvc-blank|g" pom.xml
mv src/main/resources/META-INF/native-image/am.ik.archetype/graalvm-springmvc-blank src/main/resources/META-INF/native-image/am.ik.archetype/projectName
...
sed -i.bk "s|projectName|graalvm-springmvc-blank|g" pom.xml
